...
Webflow.require('ix').init([
	{"slug":"show-sidebar-cover","name":"show sidebar cover","value":{"style":{},"triggers":[{"type":"click","selector":".sidebar-cover","stepsA":[{"display":"block","opacity":1,"wait":300,"transition":"opacity 300ms ease-in-out 0ms"}],"stepsB":[{"display":"none","opacity":0,"wait":300,"transition":"opacity 300ms ease-in-out 0ms"}]}]}},
	{"slug":"initial-sidebar-cover-state","name":"initial sidebar cover state","value":{"style":{"title":"Initial Sidebar cover state","display":"none","opacity":0},"triggers":[]}}
]);
